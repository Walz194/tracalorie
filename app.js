...
const StorageCtrl = (function () {
  ...
  return {
    storeItem: function (item) {
      let items = [];
      /*Local Storage stores only strings,so before we store in the local storage we need to parse it using JSON.Stringify but when we want to take back from local storage we need to take it back into an object with JSON.parse */
...
const App = (function (ItemCtrl, StorageCtrl, UICtrl) {
  ...
  const clearAllItemsClicked = function () {
    //Delete all items form data structur
